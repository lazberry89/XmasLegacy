...
public enum HiddenRoles implements Role {
	...
	SANTA_CLAUS(BasicRoles.MERCHANT, "&#FF0000[&#F82E2E산&#F15C5C타&#EA8989클&#E3B7B7로&#EFD4DD스&#EFD4DD]", "&#FF0000[&#FC1717S&#F82E2Ea&#F54545n&#F15C5Ct&#EE7272a&#EA8989C&#E7A0A0l&#E3B7B7a&#EFD4DDu&#EFD4DDs&#EFD4DD]"),
	ORDER_OF_KNIGHTS(BasicRoles.PRIEST, "&#E0C171[&#E4CA85신&#E9D39A의 &#F2E4C2기&#F6EDD6사&#FBF6EB단&#FFFFFF]", "&#E0C171[&#E2C579O&#E4C882r&#E5CC8Ad&#E7D092e&#E9D39Br &#EDDBABO&#EFDEB4f &#F2E5C5K&#F4E9CDn&#F6EDD5i&#F8F0DEg&#FAF4E6h&#FBF8EEt&#FDFBF7s&#FFFFFF]"),
	YONKO(null, "&#8C0000[&#C60303사&#FF0606황&#980000]", "&#8C0000[&#B20202よ&#D90404ん&#FF0606こ&#CC0303う&#980000]");

	HiddenRoles(@Nullable Role parent, @NotNull String ko, @NotNull String en) {
		this.Kor = ko;
		this.Eng = en;
		this.parent = parent;
	}
	...
	private final @Nullable Role parent;
