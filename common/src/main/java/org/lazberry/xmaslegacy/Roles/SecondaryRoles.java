...
public enum SecondaryRoles implements Role {
	GUARDIAN("가디언" , BasicRoles.KNIGHT, SecondarySkill.TARGET_GUARD, new Skill[]{SecondarySkill.OVERCHARGE_PRISM}, ThirdRoles.PALADIN), //기사 2차전직 가디언
	DEFENDER("디펜더" , BasicRoles.KNIGHT, SecondarySkill.MAGNETIC_FIELD, new Skill[]{SecondarySkill.KARMA}, ThirdRoles.PALADIN), //기사 2차전직 디펜더

	BERSERKER("버서커" , BasicRoles.WARRIOR, SecondarySkill.MADNESS, new Skill[]{SecondarySkill.TRIPLE_TOMAHAWK}), //전사 2차전직 버서커(탱커)
	...
	SecondaryRoles(String kor, @NotNull BasicRoles parent, Skill skill1, Skill[] skill2, @Nullable Role... next) {
		this.parent = parent;
		this.next = Arrays.asList(next);
		this.kor = kor;
		this.skill1 = skill1;
