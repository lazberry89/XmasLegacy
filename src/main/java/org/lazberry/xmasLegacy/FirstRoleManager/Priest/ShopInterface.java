...
public class ShopInterface implements InventoryHolder {
    ...
    public ShopInterface() {
        this.inv = Bukkit.createInventory(this, 9, ComponentChanger.comp("&c&l상점 창고"));
        ItemStack bg = ItemBuilder.of(XmasLegacy.getPlugin(XmasLegacy.class), Material.GRAY_STAINED_GLASS_PANE).setName("").setLore("").hideAllFlags().build();
